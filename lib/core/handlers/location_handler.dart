...
class LocationHandler {
  static String calculateDistance(LatLonData userLatLon, LatLonData stationLatLon) {
    final double distance = Geolocator.distanceBetween(userLatLon.lat, userLatLon.lon, stationLatLon.lat, stationLatLon.lon);
