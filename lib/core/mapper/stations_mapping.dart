...
class StationsMapping {
  ...
  static List<StationLocationQuickPreview> convertDomainStationsToStationPreview(List<DomainStations> domainList) {
  ...
  static StationDetail convertDomainStationToStationDetail(DomainStations domainStations, String distance) {
